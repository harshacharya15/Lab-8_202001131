...
![image](https://user-images.githubusercontent.com/75574683/233314356-d6da6747-c666-4e9a-acc2-98c23cf0a8c1.png)
...
```
![image](https://user-images.githubusercontent.com/75574683/233316105-addbefd8-2870-49ce-9aae-80535d127d55.png)
...
```
![image](https://user-images.githubusercontent.com/75574683/233317789-95eddce1-ea89-43c5-b3ed-1b87f297a6a0.png)
...
![image](https://user-images.githubusercontent.com/75574683/233322785-caa3fa41-cbaf-4df4-9928-48dbafe542d0.png)
...
```
This new test case checks that the lengthInInches() method returns the expected value when called on each of the Boa objects created in the setUp() method.
It uses the assertEquals() method to compare the expected value to the actual value returned by the lengthInInches() method. 
The @Test annotation indicates that this is a test method that should be run by JUnit.
